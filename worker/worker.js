...
let CONFIG = {
  ...
  "resources": {
      ...
      "photo": `https://files.catbox.moe/15u33g.jpg`,
      ...
      "favicon": `https://files.catbox.moe/75jrik.png`,
      "ogcover": `https://files.catbox.moe/vb8kf5.jpg`
  }
}
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Chikaa Ai assistant." />
    <meta name="keywords" content="chatgpt, chika, duckduckgo, AI" />
    <meta property="og:image" content="${CONFIG.resources.ogcover}"> 
    <meta name="author" content="execal">
    <title>Chika Chat</title>
    <meta charset="UTF-8" />
      ...
      <div id="popup-content">
        ...
        <div id="setting-popup" class="hidden">
          <div class="setting-option">
            <label for="particles-toggle">Particle Effects</label <label class="switch">
    ...
    <div class="chat-container">
      ...
      <div class="input-container">
        <div
          ...
          aria-multiline="true"
        ></div>
        <div id="placeholder">Tanyakan ke chat gpt...</div>
